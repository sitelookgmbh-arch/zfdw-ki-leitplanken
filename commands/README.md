...
| [`/sprint-starten`](sprint-starten.md) | Vor der ersten Änderung eines Sprints: Preflight, Statuswechsel, Routing-Eintrag |
...
Routing-Eintrag **vor** der Arbeit — hinterher ist er wertlos, weil man dann begründet, was man ohnehin
